...
@section('title', trans('admin.province.actions.index'))

@section('body')

<province-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/provinces') }}'" inline-template>

    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> {{ trans('admin.province.actions.index') }}
                    <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                        href="{{ url('admin/provinces/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp;
                        {{ trans('admin.province.actions.create') }}</a>
                </div>
                <div class="card-body" v-cloak>
                    <div class="card-block">
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'id'">{{ trans('admin.province.columns.id') }}</th>

                                    <th is='sortable' :column="'en_name'">{{ trans('admin.province.columns.en_name') }}
                                    </th>
                                    <th is='sortable' :column="'la_name'">{{ trans('admin.province.columns.la_name') }}
                                    </th>
                                    ...
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="5">
                                        <span
                                            ...
                                            @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                @click="onBulkItemsClickedAll('/admin/provinces')"
                                        ...
                                        <span class="pull-right pr-2">
                                            <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                @click="bulkDelete('/admin/provinces/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                        </span>
                        ...
                        <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/provinces/create') }}"
