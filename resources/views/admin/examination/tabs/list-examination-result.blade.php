<examination-result-listing :data="{{ $data->toJson() }}" :url="'{{ url($url) }}'" inline-template v-cloak>
    <div class="col-4">
        <div class="card">
                    ...
                    <table class="table table-hover table-listing">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in collection" :key="item.id">
                                ...
                                <td>
                                    <button :class="'btn btn-success btn-lg'">@{{ item.queue_number }}</button>
                                </td>
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-auto">
                                            <a class="btn btn-sm   btn-info"
                                                :href="'/admin/examination-results?queue_id='+item.id" role="button"><i
