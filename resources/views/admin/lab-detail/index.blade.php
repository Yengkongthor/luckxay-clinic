...
@section('title', trans('admin.lab-detail.actions.index'))

@section('body')

<lab-detail-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/lab-details') }}'" inline-template>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-primary   btn-sm pull-right m-b-0"
                        href="{{ url('admin/lab-details/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp;
                        {{ trans('admin.lab-detail.actions.create') }}</a>
                </div>
                <div class="card-body" v-cloak>
                    <div class="card-block">
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'id'">{{ trans('admin.lab-detail.columns.id') }}</th>
                                    <th is='sortable' :column="'lab_id'">{{ trans('admin.lab-detail.columns.lab_id') }}
                                    </th>
                                    <th is='sortable' :column="'name'">{{ trans('admin.lab-detail.columns.name') }}</th>
                                    <th is='sortable' :column="'unit'">{{ trans('admin.lab-detail.columns.unit') }}</th>
                                    <th is='sortable' :column="'reference'">
                                        {{ trans('admin.lab-detail.columns.reference') }}</th>
                                    <th is='sortable' :column="'cost'">{{ trans('admin.lab-detail.columns.cost') }}</th>
                                    <th is='sortable' :column="'price'">{{ trans('admin.lab-detail.columns.price') }}
                                    </th>
                        ...
                        <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary  " href="{{ url('admin/lab-details/create') }}"
