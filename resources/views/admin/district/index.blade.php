...
<district-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/districts') }}'" inline-template>
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'id'">{{ trans('admin.district.columns.id') }}</th>
                                    <th is='sortable' :column="'province_id'">
                                        {{ trans('admin.district.columns.province_id') }}</th>

                                    <th is='sortable' :column="'name'">{{ trans('admin.district.columns.name') }}</th>
