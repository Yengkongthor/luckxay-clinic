            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary   btn-sm pull-right m-b-0" href="{{ url('admin/packages/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.package.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary  " href="{{ url('admin/packages/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.package.actions.create') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
