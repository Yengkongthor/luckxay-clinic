...
<permission-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/permissions') }}'" inline-template>

    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> kkk
                    <a class="btn btn-primary   btn-sm pull-right m-b-0"
                        href="{{ url('admin/permissions/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp;
                        {{ trans('admin.permission.actions.create') }}</a>
                </div>
                <div class="card-body" v-cloak>
                    <div class="card-block">
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'guard_name'">
                                        {{ trans('admin.permission.columns.guard_name') }}</th>
                        ...
                        <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary  " href="{{ url('admin/permissions/create') }}"
