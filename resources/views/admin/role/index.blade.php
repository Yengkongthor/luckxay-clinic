...
<role-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/roles') }}'" inline-template>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-primary   btn-sm pull-right m-b-0"
                        href="{{ url('admin/roles/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp;
                        {{ trans('admin.role.actions.create') }}</a>
                </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'guard_name'">
                                        {{ trans('admin.role.columns.guard_name') }}</th>
