...
class FillPermissionsForMedicinePricing extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMedicinePricing constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.medicine-pricing',
            'admin.medicine-pricing.index',
            'admin.medicine-pricing.create',
            'admin.medicine-pricing.show',
            'admin.medicine-pricing.edit',
            'admin.medicine-pricing.delete',
            'admin.medicine-pricing.bulk-delete',
        ]);
