...
class FillPermissionsForDoctorMedicine extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDoctorMedicine constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.doctor-medicine',
            'admin.doctor-medicine.index',
            'admin.doctor-medicine.create',
            'admin.doctor-medicine.show',
            'admin.doctor-medicine.edit',
            'admin.doctor-medicine.delete',
            'admin.doctor-medicine.bulk-delete',
        ]);
