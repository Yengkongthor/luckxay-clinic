...
class FillPermissionsForExcludeDate extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForExcludeDate constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.exclude-date',
            'admin.exclude-date.index',
            'admin.exclude-date.create',
            'admin.exclude-date.show',
            'admin.exclude-date.edit',
            'admin.exclude-date.delete',
            'admin.exclude-date.bulk-delete',
        ]);
