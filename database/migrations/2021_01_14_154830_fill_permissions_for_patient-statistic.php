...
class FillPermissionsForPatientStatistic extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPatientStatistic constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.patient-statistic',
            'admin.patient-statistic.index',
            'admin.patient-statistic.create',
            'admin.patient-statistic.show',
            'admin.patient-statistic.edit',
            'admin.patient-statistic.delete',
            'admin.patient-statistic.bulk-delete',
        ]);
