...
class FillPermissionsForBasicPhysicalExamination extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBasicPhysicalExamination constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.basic-physical-examination',
            'admin.basic-physical-examination.index',
            'admin.basic-physical-examination.create',
            'admin.basic-physical-examination.show',
            'admin.basic-physical-examination.edit',
            'admin.basic-physical-examination.delete',
            'admin.basic-physical-examination.bulk-delete',
        ]);
