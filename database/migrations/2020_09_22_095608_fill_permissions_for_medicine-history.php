...
class FillPermissionsForMedicineHistory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMedicineHistory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.medicine-history',
            'admin.medicine-history.index',
            'admin.medicine-history.create',
            'admin.medicine-history.show',
            'admin.medicine-history.edit',
            'admin.medicine-history.delete',
            'admin.medicine-history.bulk-delete',
        ]);
