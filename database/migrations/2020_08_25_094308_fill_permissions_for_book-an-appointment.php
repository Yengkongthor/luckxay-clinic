...
class FillPermissionsForBookAnAppointment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBookAnAppointment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.book-an-appointment.index',
            'admin.book-an-appointment.create',
            'admin.book-an-appointment.show',
            'admin.book-an-appointment.edit',
            'admin.book-an-appointment.delete',
            'admin.book-an-appointment.bulk-delete',
        ]);
