...
class FillPermissionsForEmployeeStatus extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEmployeeStatus constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.employee-status.index',
            'admin.employee-status.create',
            'admin.employee-status.show',
            'admin.employee-status.edit',
            'admin.employee-status.delete',
            'admin.employee-status.bulk-delete',
        ]);
