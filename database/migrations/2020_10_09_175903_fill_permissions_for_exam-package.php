...
class FillPermissionsForExamPackage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForExamPackage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.exam-package',
            'admin.exam-package.index',
            'admin.exam-package.create',
            'admin.exam-package.show',
            'admin.exam-package.edit',
            'admin.exam-package.delete',
            'admin.exam-package.bulk-delete',
        ]);
