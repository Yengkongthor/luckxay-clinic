...
class FillPermissionsForBookingTime extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBookingTime constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.booking-time',
            'admin.booking-time.index',
            'admin.booking-time.create',
            'admin.booking-time.show',
            'admin.booking-time.edit',
            'admin.booking-time.delete',
            'admin.booking-time.bulk-delete',
        ]);
