...
class FillPermissionsForBookingDate extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBookingDate constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.booking-date',
            'admin.booking-date.index',
            'admin.booking-date.create',
            'admin.booking-date.show',
            'admin.booking-date.edit',
            'admin.booking-date.delete',
            'admin.booking-date.bulk-delete',
        ]);
