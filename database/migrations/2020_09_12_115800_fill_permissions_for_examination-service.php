...
class FillPermissionsForExaminationService extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForExaminationService constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.examination-service',
            'admin.examination-service.index',
            'admin.examination-service.create',
            'admin.examination-service.show',
            'admin.examination-service.edit',
            'admin.examination-service.delete',
            'admin.examination-service.bulk-delete',
        ]);
