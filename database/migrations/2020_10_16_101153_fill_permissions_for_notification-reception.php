...
class FillPermissionsForNotificationReception extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForNotificationReception constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.notification-reception.index',
            'admin.notification-reception.create',
            'admin.notification-reception.show',
            'admin.notification-reception.edit',
            'admin.notification-reception.delete',
            'admin.notification-reception.bulk-delete',
        ]);
