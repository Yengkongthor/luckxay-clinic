...
class FillPermissionsForShoppingCart extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForShoppingCart constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.shopping-cart',
            'admin.shopping-cart.index',
            'admin.shopping-cart.create',
            'admin.shopping-cart.show',
            'admin.shopping-cart.edit',
            'admin.shopping-cart.delete',
            'admin.shopping-cart.bulk-delete',
        ]);
