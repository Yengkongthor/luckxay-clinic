...
class FillPermissionsForHealthTip extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHealthTip constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.health-tip',
            'admin.health-tip.index',
            'admin.health-tip.create',
            'admin.health-tip.show',
            'admin.health-tip.edit',
            'admin.health-tip.delete',
            'admin.health-tip.bulk-delete',
        ]);
