...
class FillPermissionsForPatientHistory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPatientHistory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.patient-history.index',
            'admin.patient-history.create',
            'admin.patient-history.show',
            'admin.patient-history.edit',
            'admin.patient-history.delete',
            'admin.patient-history.bulk-delete',
        ]);
