...
class FillPermissionsForLabDetail extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLabDetail constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.lab-detail',
            'admin.lab-detail.index',
            'admin.lab-detail.create',
            'admin.lab-detail.show',
            'admin.lab-detail.edit',
            'admin.lab-detail.delete',
            'admin.lab-detail.bulk-delete',
        ]);
