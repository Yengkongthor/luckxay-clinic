...
class FillPermissionsForLabXrayEcho extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLabXrayEcho constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.lab-xray-echo',
            'admin.lab-xray-echo.index',
            'admin.lab-xray-echo.create',
            'admin.lab-xray-echo.show',
            'admin.lab-xray-echo.edit',
            'admin.lab-xray-echo.delete',
            'admin.lab-xray-echo.bulk-delete',
        ]);
